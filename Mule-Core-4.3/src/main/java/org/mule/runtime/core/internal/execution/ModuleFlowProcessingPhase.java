...
public abstract class ModuleFlowProcessingPhase {
	...
	private Consumer<CoreEvent> onMessageReceived(FlowProcessingPhaseTemplate template,MessageProcessContext messageProcessContext, FlowConstruct flowConstruct) {
